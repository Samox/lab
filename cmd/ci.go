...
var ciCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err := a.SetRoot(root, true).SetBeforeDrawFunc(jobsLayout(jobsCh, root)).SetAfterDrawFunc(connectJobs).Run(); err != nil {
			log.Fatal(err)
		}
	},
}
...
func jobsLayout(jobsCh chan []gitlab.Job, root *tview.Pages) func(screen tcell.Screen) bool {
